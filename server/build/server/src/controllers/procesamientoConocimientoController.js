...
class ProcesamientoConocimientoController {
    getAll(req, res) {
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            res.status(404).json({ text: "el procesamiento de conocimiento no existe" });
            //res.json({text:'listando un caso'+ req.params.id});
        });
    }
}
exports.procesamientoConocimientoController = new ProcesamientoConocimientoController();
exports.default = exports.procesamientoConocimientoController;
