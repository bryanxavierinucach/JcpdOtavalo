...
class ProvinciasController {
    ...
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const provincia = yield database_1.default.query('SELECT * FROM t_provincias');
            res.json(provincia);
        });
    }
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const provincia = yield database_1.default.query('SELECT * FROM t_provincias WHERE prov_id = ? ', [id]);
