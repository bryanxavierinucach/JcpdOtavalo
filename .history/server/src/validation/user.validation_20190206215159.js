...
// import response from('./../general//MyResponse.js'); //common function for every http response inside general folder
// import messages from('./../general/messages'); //common files inside general folder for each error message in app
